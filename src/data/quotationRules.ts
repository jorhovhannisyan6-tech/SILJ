...
export const FIXED_QUOTATION_RULES: Record<InsuranceProductType, FixedProductRule> = {
  ...
  "property-all-risks": {
    product: "property-all-risks",
    nameArm: "Գույքի ապահովագրություն բոլոր ռիսկերից",
    stage2TitleArm: "Գույքի All Risks տվյալներ",
    stage2DescriptionArm: "Նշեք գույքի տեսակը, գտնվելու վայրը, արժեքը, հակահրդեհային և պահպանության համակարգերը All Risks ծածկույթի համար։",
    minInsuredAmount: 1,
    minTariff: 0.08,
    maxTariff: 1.8,
    defaultTariff: 0.28,
    defaultFranchise: 0.5,
    requiredRisks: [],
    availableRisks: ["Հրդեհ և պայթյուն","Բոլոր բնական աղետներ","Ջրամատակարարման վթարներ","Գողություն և կողոպուտ","Վանդալիզմ","Բախում և անկում","Մեխանիկական պատահական վնասներ"],
    excludedActivities: [],
    requiredDocuments: ["Գույքի սեփականության կամ օգտագործման իրավունքը հաստատող փաստաթուղթ", "Անվտանգության համակարգերի տվյալներ"],
    allowedCurrencies: ["AMD", "USD", "EUR"],
    riskTariffAdjustments: {},
  },
  casco: {
